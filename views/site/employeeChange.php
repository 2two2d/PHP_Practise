<div>
    <form action="" method="post">
        ...
        <label for="">Имя<br><input type="text" name="username" value="<?=$employee->username;?>"></label><br>
        <label for="">Фамилия<br><input type="text" name="username" value="<?=$employee->username;?>"></label><br>
        <label for="">Отчество<br><input type="text" name="username" value="<?=$employee->username;?>"></label><br>
        <label for="">Пол<br>
            <select name="sex" id="">
        ...
        <label for="">Дата рождения<br><input type="text" name="username" value="<?=$employee->username;?>"></label><br>
        <label for="">Адрес<br><input type="text" name="username" value="<?=$employee->username;?>"></label><br>
        ...
        <label for="">Почта<br><input type="text" name="username" value="<?=$employee->username;?>"></label><br>
        <label for="">Пароль<br><input type="text" name="username" value="<?=$employee->username;?>"></label><br>
        <input type="submit" name="changeEmployee" value="Изменить данные">
    </form>
</div>
<style>
    div{
